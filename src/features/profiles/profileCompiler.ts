...
function parseSettingPath(path: string): {
    ...
    const pathMappings: Record<string, { name: string; unit?: string; section: string }> = {
        ...
        '/print_settings/external_perimeter_speed': { name: 'External Perimeter Speed', unit: 'mm/s', section: 'Speed' },
        ...
        '/print_settings/fuzzy_skin': { name: 'Fuzzy Skin', section: 'Quality' },
        '/print_settings/fuzzy_skin_thickness': { name: 'Fuzzy Skin Thickness', unit: 'mm', section: 'Quality' },
        '/print_settings/fuzzy_skin_point_dist': { name: 'Fuzzy Skin Point Distance', unit: 'mm', section: 'Quality' },
